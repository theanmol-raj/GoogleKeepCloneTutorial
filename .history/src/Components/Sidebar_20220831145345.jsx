...
function Sidebar(props) {
  return (
    <div className={` ${props.sidebar? ' md:w-72' : ' w-0'} pt-20 flex shadow-xl flex-col items-start  h-full transform transition-width duration-500 ease-out  font-semibold `}>
