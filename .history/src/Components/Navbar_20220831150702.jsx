  ...
  return (
    <div className=" fixed top-0 w-screen px-3 py-2 z-50 flex justify-between items-center border-b border-gray-300 shadow-md bg-white">
      ...
      <div className="w-full max-w-4xl">
        <input placeholder="Search" onClick={()=> setSearch(true)} onMouseLeave={()=>setSearch(false)} className={` cursor-pointer ${search ? 'bg-white shadow-md' : 'bg-gray-200' }  border rounded-lg pl-8 pr-4  p-3 max-w-3xl w-full `} />
      </div>
