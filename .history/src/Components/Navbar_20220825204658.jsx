...
function Navbar() {
  return (
    <div className=" fixed top-0 w-screen px-3 py-2 flex justify-between items-center border-b border-gray-300 shadow-md bg-white">
      ...
      <div className=" flex items-center text-gray-700 text-2xl space-x-2">
            <ReplayIcon fontSize="inherit" /><ViewStreamIcon fontSize="inherit" /> <SettingsIcon fontSize="inherit" />
      </div>
        <div className=" flex items-center space-x-2">
        <div className=" hover:bg-gray-200 p-2 text-gray-700 text-2xl rounded-full cursor-pointer">
